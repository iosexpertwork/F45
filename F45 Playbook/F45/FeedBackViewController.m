...
-(void)configureHost {
     self.hostView = [(CPTGraphHostingView *) [CPTGraphHostingView alloc] initWithFrame:CGRectMake(0, 200, 320, 300)];
...
-(void)configureGraph {
   ...
   // CPTGraph *graph = [[CPTXYGraph alloc] initWithFrame:self.hostView.bounds];
    CPTGraph *graph = [[CPTXYGraph alloc] initWithFrame:CGRectMake(0, 200, 320, 300)];
...
-(void)configurePlots
{
    ...
    // 3 - Set up plot space
    [plotSpace scaleToFitPlots:[NSArray arrayWithObjects: googPlot, msftPlot, nil]];
